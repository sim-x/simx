...
public:
  ...
  /// krb - allow one argument constructor
  template<typename T1>
  AbstractProduct* CreateObject(const IdentifierType& id, T1& a1)
    {
      typename IdToProductMap::const_iterator i = associations_.find(id);
      if (i != associations_.end())
      {
  ...
  /// krb - allow two argument constructor
  template<typename T1, typename T2>
  AbstractProduct* CreateObject(const IdentifierType& id, T1& a1, T2& a2)
    {
      typename IdToProductMap::const_iterator i = associations_.find(id);
      if (i != associations_.end())
      {
        return (i->second)(a1, a2);
      }
      return FactoryErrorPolicy<IdentifierType, AbstractProduct>::OnUnknownType(id);
    }

  /// krb - allow three argument constructor
  template<typename T1, typename T2, typename T3>
  AbstractProduct* CreateObject(const IdentifierType& id, T1& a1, T2& a2, T3& a3)
    {
      typename IdToProductMap::const_iterator i = associations_.find(id);
      if (i != associations_.end())
      {
        return (i->second)(a1, a2, a3);
      }
      return FactoryErrorPolicy<IdentifierType, AbstractProduct>::OnUnknownType(id);
    }

/// four argument constructor - ST
template<typename T1, typename T2, typename T3, typename T4>
AbstractProduct* CreateObject(const IdentifierType& id, T1& a1, T2& a2, T3& a3, T4& a4)
    {
      typename IdToProductMap::const_iterator i = associations_.find(id);
      if (i != associations_.end())
      {
        return (i->second)(a1, a2, a3, a4);
      }
      return FactoryErrorPolicy<IdentifierType, AbstractProduct>::OnUnknownType(id);
    }
