...
#ifndef BOOST_INNER_SMART_ASSERT_PERSIST_IMPL_HPP_INCLUDED
#define BOOST_INNER_SMART_ASSERT_PERSIST_IMPL_HPP_INCLUDED

#if _MSC_VER >= 1020
#pragma once
#endif

// nothing - all code is inline
