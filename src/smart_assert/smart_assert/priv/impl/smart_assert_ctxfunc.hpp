...
#ifndef BOOST_INNER_SMART_ASSERT_CONTEXT_FUNC_IMPL_HPP_INCLUDED
#define BOOST_INNER_SMART_ASSERT_CONTEXT_FUNC_IMPL_HPP_INCLUDED

#if _MSC_VER >= 1020
#pragma once
#endif

// nothing - all is inline
