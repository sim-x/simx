...
#include <string.h>
#include <stdlib.h>
/*#include "random/memory.h"*/
#include "random/sprng_primes_32.h"
#include "random/sprng_interface.h"
#include "random/sprng_lcg.h"
#include <limits.h>
#include "random/sprng_store.h"
...
#else
#error "long long int type is not defined"
#endif
...
#include "random/sprng_multiply.h"
...
#endif
{
  ...
  unsigned int size;
#ifndef LONG64	/* if no 64 bit integer types */
  unsigned int m[2];
#endif
  struct rngen *q;
