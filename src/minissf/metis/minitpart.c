 ...
 * George
 *
 * $Id: minitpart.c,v 1.1.1.1 2004/07/21 21:01:31 jasonliu Exp $
 *
 */
...
extern int SelectQueueOneWay(int ncon, float *npwgts, float *tpwgts, int from, PQueueType queues[MAXNCON][2]);
